...
public class ImageBean implements Parcelable
{
    ...
    private String noAddBaseUrlPath;
    ...
    public String getNoAddBaseUrlPath() {
        return noAddBaseUrlPath;
    }

    public void setNoAddBaseUrlPath(String noAddBaseUrlPath) {
        this.noAddBaseUrlPath = noAddBaseUrlPath;
    }
