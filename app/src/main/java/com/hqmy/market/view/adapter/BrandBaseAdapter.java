...
public  class BrandBaseAdapter extends BaseRecycleViewAdapter implements AutoLocateHorizontalView.IAutoLocateHorizontalView{
    private View view;
...
//        holders.tvState.setText(data.getState()==1?"抢购进行中":(data.getState()==2?"已开抢":"即将开始"));
    ...
    public interface  ItemClickListener{
        void itemClick(int poition, BaseDto2 data);
    }
