...
/**
 * Created by rzb on 2019/7/4.
 */
public class CYBChangeCityGridViewAdapter extends BaseAdapter {

	private List<HotCityDto> list;
	private Context          context;
	private LayoutInflater   inflater;

	public CYBChangeCityGridViewAdapter(Context context, List<HotCityDto> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.item_gridview_cyb_change_city_tv.setText(list.get(position).getName());
		return convertView;
	}
