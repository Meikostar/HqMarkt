...
import com.hqmy.market.view.adapter.CollectGoodsAdapter;
...
public class CollectGoodsFragment extends BaseFragment {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()){
                    ...
                    case R.id.tv_deleted:
                        //移除
                        removeCollect(mAdapter.getItem(position).getId(),position);
                        break;
                }
            }
        });
     ...
     * @param
     */
    private void removeCollect(String id,int position) {
    ...
    private void removeSuccess(int position){
