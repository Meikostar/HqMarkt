...
import com.hqmy.market.view.adapter.ExpressListAdapter;
...
public class ExpressListDialog extends Dialog {
    ...
    List<ExpressList> mReasons = new ArrayList<>();
    public ExpressListDialog(Context context, DialogListener dialogListener, List<ExpressList> reasons) {
    ...
    private void initAdapter() {
        ...
        mAdapter = new ExpressListAdapter(mReasons);
...
//                mAdapter.setSelPositon(position);
    ...
    public interface DialogListener {
        void sureItem(int position, ExpressList expressList);
    }
}
