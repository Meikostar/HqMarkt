...
public class ShopInfoBean {
    ...
    public String      user_id;//    images/activity.png
    public String      name;//    images/activity.png
    ...
    public String       lng;//    images/activity.png
    ...
    public ShopInfoBean       ext;//    images/activity.png
    public String       instructions;//    images/activity.png
    ...
    public String       storehouse_area_id;//    images/activity.png
    public String       followings_count;//    images/activity.png
    public boolean       is_following;//    images/activity.png
    public String       status_desc;//    images/activity.png
